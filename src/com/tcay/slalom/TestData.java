...
//            race.addBoat( new Racer("10",  "HRADILEK",    "Vavrinec",  "M","CZE"), boatClass);
            ...
            boatClass = "K1W";
            race.addBoat( new Racer("27",  "LIEBFARTH",  "Evy",     "F", "NRC"), boatClass);
            race.addBoat( new Racer("28",  "DAVIS",      "Avery",   "F", "NRC"), boatClass);
//            race.addBoat( new Racer("29",  "VANHA",      "Zuzana",  "F", "NRC"), boatClass);
// Temp D20160417
